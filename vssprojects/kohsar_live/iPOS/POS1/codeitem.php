...
{//changed $dbname_main to $dbname_detail on line 190 by ahsan 22/02/2012
  $salerows	=	$AdminDAO->getrows("$dbname_detail.saledetail",'remainingstock,pksaledetailid,fkdiscountid,fkstockid,saleprice, sum( quantity ) AS quantity, sum( saleprice * quantity ) AS subtotal, boxsize ,fkbarcodeid'," fksaleid='$tempsaleid' group by fkstockid,saleprice,fkdiscountid ORDER BY pksaledetailid DESC");
}
  $items=0;
  for($i=0;$i<count($salerows);$i++)
  {
	...
	{//changed $dbname_main to $dbname_detail on line 207 by ahsan 22/02/2012
		...
		$productrow		=	$AdminDAO->queryresult($sql);
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$sql_new=" SELECT itemdescription,shortdescription 	FROM  barcode WHERE pkbarcodeid='$fbarcde'";
		$productrow_new		=	$AdminDAO->queryresult($sql_new);
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$productnameinv	=	$productrow_new[0]['shortdescription'];
		$itembarcode	=	$productrow[0]['barcode'];
		$costprice		=	$productrow[0]['costprice'];
		if($productnameinv=='')
		{
			$productnameinv	=	$productrow_new[0]['itemdescription'];
		}
	}
 	if($quantity>0)
	{
  ...
  ?>
	...
	{//changed $dbname_main to $dbname_detail on line 308 by ahsan 22/02/2012
		$salerows	=	$AdminDAO->getrows("$dbname_detail.saledetail",'pksaledetailid,fkstockid,saleprice, sum(quantity) AS qty,quantity, sum( saleprice * quantity ) AS subtotal, boxsize , fkbarcodeid '," fksaleid='$tempsaleid' AND quantity<0 group by fkstockid,saleprice");
	}
 // $totalitems	=	count($salerows);
  $items=0;
  for($i=0;$i<count($salerows);$i++)
  {
	...
	{//changed $dbname_main to $dbname_detail on line 325 by ahsan 22/02/2012
		...
		///$productrow		=	$AdminDAO->queryresult($sql);
		 ...
		 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$sql=" SELECT itemdescription,shortdescription 	FROM  barcode WHERE pkbarcodeid='$fbarcde'";
        $productrow		=	$AdminDAO->queryresult($sql);
     ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
