...
class PagedResults {
   ...
   function pageHTML($qrysring='')
   {
		...
		//line copied from store_paging.class.php, by ahsan 15/02/2012
		//$ret="<select id='pageno' name='pageno'>";
		...
		for($i=1; $i<=$total; $i++) 
		{
			...
			//line copied from store_paging.class.php, by ahsan 15/02/2012
			//$ret.="<option value='' $selected onclick='$pageurl'>$i</option>";
	   ...
	   //onChange='$purl'
		...
		//line copied from store_paging.class.php, by ahsan 15/02/2012
	   //$pagelimit	=	"<select name=\"pagelimit\" id=\"pagelimit\" onChange='$purl'><option value=\"10\" $sel10>10</option><option value=\"15\" $sel15>15</option><option value=\"30\" $sel30>30</option><option value=\"50\" $sel50>50</option><option value=\"100\" $sel100>100</option></select>";
