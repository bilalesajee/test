 ...
 //This page is a result of an autogenerated content made by running test.html with firefox.
            function hotkey()
			{
                ...
                */
                ...
                jQuery(document).bind('keydown', 'Ctrl+', function (evt){jQuery('#_Ctrl_esc').addClass('dirty'); return false; });
                ...
                jQuery(document).bind('keydown', 'Shift+', function (evt){jQuery('#_Shift_esc').addClass('dirty'); return false; });
                ...
                jQuery(document).bind('keydown', 'Alt+', function (evt){jQuery('#_Alt_esc').addClass('dirty'); return false; });
