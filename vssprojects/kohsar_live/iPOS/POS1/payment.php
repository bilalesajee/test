    ...
    <div class="Table">
      <div class="Row">
        ...
        <div id="payment_details2" style="display:none;">
          ...
          <div class="Column">
            <label>Charges</label>
            <input type="text" name="creditcharges" class="text" id="creditcharges" value="" onkeydown="javascript:if(event.keyCode==13) {processcreditcard(); return false;}" onkeypress="return isNumberKey(event)"/>
          </div>
          <div class="Column">
            <label>Type</label>
...
<input type="radio" name="card" id="card" value="2">&nbsp;MCB<?php //echo $ccs; ?><!--<a href="javascript:void(0)" onclick="addnewtext('addcc','newcard','Add New');" style="font-size:10px"> New</a>--></div>
          ...
          <div class="Column">
            <label>CC #</label>
            <input type="text" name="ccnumber" class="text" id="ccnumber"  value="" onkeydown="javascript:if(event.keyCode==13) {processcreditcard(); return false;}" maxlength="4"/>
          </div>
          <div class="Row">
            <div class="Column">
              <label>&nbsp;</label>
