...
function confpayout()
{
	...
	if(pdesc=='')
	{
		...
		processpayout(); //On Pay Now button the bellow functionality was calling but Now this is off told by siddique sir By Sabz Ali 15/05/2012
    ...
    <div class="Table" >
        <div class="Row">
         ...
         <!--   <option value="ch">Cheque</option>-->
          ...
          </select><input type="hidden" name="accountid" id="accountid" value="1" />
            </div>
