...
if(sizeof($_POST)>0)
{
	...
	if($insertid > 0){
		       file_get_contents("http://192.168.10.110/admin/accounts/counter_payout_mail.php?counter=$countername&closing=$closingsession&cashier=$empid&accounttitle=".urlencode($accountname)."&currentpayout=$amount");
		}
