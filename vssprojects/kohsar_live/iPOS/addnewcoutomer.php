...
<table class="price">
    ...
    <tr>
    <th><span class="compulsory">Mobile Number</span></th>
    <td><input type="text" name="mbphone" id="mbphone" class="text" onkeydown="javascript:if(event.keyCode==13) {savecustomer(1); return false;}" value="<?php echo $mphone;?>"/></td>
    </tr>
    <tr>
    <th>Fax</th>
    ...
    <input type="hidden" name="employeeid" value="<?php echo $_SESSION['addressbookid'];?>" />
    <span class="buttons">
