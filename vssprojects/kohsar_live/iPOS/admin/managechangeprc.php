...
function viewreport()
{
	...
	if(document.getElementById('itemdescription').value==''){
		bar2=document.getElementById('barcode').value;
		}else{
			bar1=document.getElementById('barcodeid').value;
	...
	window.open('pricechangedetail.php?id1='+bar1+'&id2='+bar2,"myWin","menubar,scrollbars,left=30px,top=40px,height=400px,width=600px");
				}
}
...
<div id="reportsdiv">
  <form name="frmreport" id="frmreport" style="width:920px;" class="form">
    <fieldset>
      <legend> Price change Report</legend>
      <div style="float:right"> <span class="buttons">
        <button type="button" class="positive" onclick="viewreport();"> <img src="../images/tick.png" alt=""/> Submit </button>
      ...
      <table width="100%">
        ...
        <tr>
          <td colspan="2"><div class="buttons">
              <button type="button" class="positive" id="btn2" onclick="viewreport();"> <img src="../images/tick.png" alt=""/> Submit </button>
              <a href="javascript:void(0);" onclick="hidediv('reportsdiv');" class="negative"> <img src="../images/cross.png" alt=""/> Cancel </a> </div></td>
        </tr>
      </table>
    </fieldset>
