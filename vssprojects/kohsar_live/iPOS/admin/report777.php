...
$invoice_list	=	$AdminDAO->getrows("$dbname_detail.supplierinvoice","pksupplierinvoiceid,concat(pksupplierinvoiceid,' (',billnumber,')') billnumber","fksupplierid!=''");
$d1			=	"<select name=\"invoice[]\" id=\"invoice[]\" style=\"width:150px;\"><option >Select Invoice</option>";
