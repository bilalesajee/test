...

{
	...
	window.open('showstock_report.php?sdate='+sd+'&edate='+ed+'&loc='+pred3+'&type=brand',"myWin","menubar,scrollbars,left=30px,top=40px,height=400px,width=600px");
    ...
    <fieldset>
      ...
      <tr>
        ...
        <td width="16%"><table width="100%">
         ...
         <!-- <tr>
          ...
          <tr >
            ...
            <td width="15%">Select Report Type : </td>
            ...
            <td><select id="rtype" name="rtype">
              ...
              <option value="2">Brand Wise</option>
         ...
         <!-- <tr id="procat">
            ...
            <td width="16%"><input type="checkbox" id="productcat1" name="productcat1" onclick="disablearr(1);" /></td>

            <td width="69%"  align="left"  id="proname" style="display:none;"> Product Name  :&nbsp;&nbsp;
       ...
       <!--   <tr >
            ...
            <td width="15%"  align="left"> Select Brand Name :</td>
