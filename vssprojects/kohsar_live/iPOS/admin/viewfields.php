...
$query 	= 	"SELECT 
			...
			";
$navbtn	=	"";
$navbtn .= "<a class='button2' id='addfields' onmouseover='buttonmouseover(this.id)' onmouseout='buttonmouseout(this.id)' href=\"javascript:showpage(0,'','addfield.php','subsubgrid','$div','$delid')\" title='Add Field'>
				<span class='addrecord'>&nbsp;</span>
				</a>&nbsp;";
$navbtn .="	<a class=\"button2\" id=\"editfields\" onmouseover=\"buttonmouseover(this.id)\" onmouseout=\"buttonmouseout(this.id)\" href=javascript:showpage(1,document.$form.checks,'addfield.php','subsubgrid','$div','$delid') title=\"Edit Field\"><span class=\"editrecord\">&nbsp;</span></a>&nbsp;";
