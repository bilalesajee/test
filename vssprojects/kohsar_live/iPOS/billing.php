...
*///changed $dbname_main to $dbname_detail on line 229, 230 by ahsan 22/02/2012
 	...
 	$query	=	"SELECT 
				...
				(SELECT CONCAT(firstname ,' ', lastname)cn FROM $dbname_detail.sale st1 ,customer c WHERE st.pksaleid = st1.pksaleid AND pkcustomerid = fkaccountid) AS cn
...

{
	...
	$fields = array("pksaleid","serialno","datetime","countername","employeename","cn");
...

{
	...
	$navbtn.=	"&nbsp;|&nbsp;<a class=\"button2\" id=\"editbrands\" onmouseover=\"buttonmouseover(this.id)\" onmouseout=\"buttonmouseout(this.id)\" href=\"javascript:void(0)\" onClick=\"showpage(1,document.$form.checks,'sale.php','main-content','mainpanel','delievrychalan&invmode=1')\" title=\"Edit Invoice\"><span class=\"\">Edit</span></a>&nbsp;

			";
	/*$navbtn .=" &nbsp;|&nbsp;<a class=\"n\" id=\"returns\" onmouseover=\"buttonmouseover(this.id)\" onmouseout=\"buttonmouseout(this.id)\"&nbsp;<a href=\"javascript: isclosestatus('close')\" title=\"close status\"><b>Close</b></a>&nbsp;";*/

/*$navbtn.= "&nbsp;|&nbsp;<a class=\"button2\" id=\"editbrands\" onmouseover=\"buttonmouseover(this.id)\" onmouseout=\"buttonmouseout(this.id)\" href=\"javascript:void(0)\" onClick=\"showpage(1,document.$form.checks,'rsale.php','main-content','mainpanel','delievrychalan&invmode=1')\" title=\"Edit Invoice\"><span class=\"\">Return</span></a>&nbsp";*/
...
function isclosestatus(text)
{
	...
	$.ajax({
type: "GET",
url: 'billing_status.php',
success: response,
data: 'ids='+ids+'&is_close='+text,


});
//loadsection('maindiv','billing.php');
