...
class grid
{
	...
	function grid()
	{
		//$this->pager = new PagedResults();
	}
	function settotalrecords($nor)
	{
		$this->totalrecords	=	$nor;
	}
	function setperpagerecords($perpagerecords)
	{
	...
	function setpager()
	{
		$this->Pager->TotalResults 	=	$this->totalrecords;
		$this->Pager->ResultsPerPage =	$this->perpagerecords; 
	}
...
//
//function grid(Labels_array,database_fields_array,Dbresults_array,paging_Limit,Navigation_buttons_array,Navigation_btn_links array,csspath);
...
<table border="0" cellspacing="0" cellpadding="1" width="920">
	...
	<tr height="20" valign="middle">
		<th width="896" colspan="5" align="left" style="padding-left:15px">
				...
				<a href="javascript: getsuppliers('subgrid','viewsuppliers.php')" title="View Suppliers">SUPPLIERS</a></th>
	</tr>
	<thead>
</table>
<?php
