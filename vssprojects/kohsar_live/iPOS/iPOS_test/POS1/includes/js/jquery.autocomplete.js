...
$.fn.extend({
	autocomplete: function(urlOrData, options) {
		...
		//add from store_jquery.autocomplete.js by ahsan 21/02/2012
...
$.Autocompleter = function(input, options) {
	...
	//line added from store_jquery.autocomplete.js by ahsan 21/02/2012
   	var lastAjaxCall     = {query:""};  // HLS - for options.listIsSorted //from main, edit by Ahsan 13/02/2012
	var config = {
	...
	//add from store_jquery.autocomplete.js
	//from main, start edit by Ahsan 13/02/2012
...
//end add		
	...
	function selectCurrent() {
		...
		if ( options.multiple ) {
			...
			if ( words.length > 1 ) {
				//line added from store_jquery.autocomplete.js by ahsan 21/02/2012
	            v = words.slice(0, words.length - 1).join( options.multipleSeparator ) + options.multipleSeparator + v;//from main, edit by ahsan 13/02/2012
	...
	//add from store_jquery.autocomplete.js by ahsan 21/02/2012 
   function autoFill_main(q, sValue){
      // autofill in the complete box w/the first match as long as the user hasn't entered in more data
      // if the last user key pressed was backspace, don't autofill
...
//from main, start edit by ahsan 13/02/2012
   ...
   function request_main(term, success, failure) {
...
$.Autocompleter.defaults = {
	...
	//added from store_jquery.autocomplete.js by ahsan 21/02/2012
//from main, start edit by ahsan 13/02/2012
...
//end edit
	...
	//formatItem: function(value) { return value[0]; }, // HLS - return value[0] //from main
	formatMatch: null,
	//line added from store_jquery.autocomplete.js by ahsan 21/02/2012
   	moreItems: "",//from main, edit by ahsan 13/02/2012
	autoFill: false,
	width: 0,
	multiple: false,
	multipleSeparator: ", ",
...
$.Autocompleter.Select = function (options, input, select, config) {
	var CLASSES = {
		ACTIVE: "ac_over"
		//line added from store_jquery.autocomplete.js by ahsan 21/02/2012
//		      ACTIVE: options.overClass  //HLS - was "ac_over" //from main, edit by ahsan 13/02/2012
	};
	...
	function init() {
		...
		//line added from store_jquery.autocomplete.js by ahsan 21/02/2012
//      .appendTo(options.attachTo);//from main, edit by ahsan 13/02/2012
...
//end add
	...
	function fillList() {
		...
		for (var i=0; i < max; i++) {
			...
			//line added from store_jquery.autocomplete.js by ahsan 21/02/2012
//	         var li = $("<li>").html( options.highlight(formatted, term) ).appendTo(list)[0]; //from main, edit by ahsan 13/02/2012
...
//end add
		...
		selected: function() {
			...
			//line added from store_jquery.autocomplete.js by ahsan 21/02/2012
         	//return listItems && $.data(listItems.filter("." + CLASSES.ACTIVE)[0], "ac_data");//from main, edit by ahsan 13/02/2012
		},
		emptyList: function (){
			list && list.empty();
		},
