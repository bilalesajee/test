...
if (sizeof($_POST) > 0)
{
    ...
    if ($newstock != '')
    {
        ...
        if ($newstock == 'exp')
        {
            ...
            $fields = array("batch", "quantity", "unitsremaining", "expiry", "purchaseprice", "costprice", "retailprice", "priceinrs", "shipmentcharges", "fkshipmentgroupid", "fkshipmentid", "fkbarcodeid", "fksupplierid", "fkstoreid", "fkemployeeid", "fkbrandid","addtime");
    ...
    if ($tempsaleid != '')
    {
        ...
        else
        {
            ...
            //echo $remainingquant; exit;
                ...
                $boxbarcode_get_bar = $AdminDAO->getrows("barcode", "pkbarcodeid", " barcode = '$barcode'");
                $pkboxbarcodeiD = $boxbarcode_get_bar[0]['pkbarcodeid'];

            $fields = array("fksaleid", "fkstockid", "quantity", "saleprice", "originalprice", "fkreasonid", "fkdiscountid", "counterdiscount", "discountamount", "timestamp", "boxsize", "fkclosingid", "fkpodetailid", "fkaccountid", "taxamount", "taxable", "remainingstock","fkbarcodeid");

            $data = array($tempsaleid, $stockid, $quantity, $newprice, $price, $reason, $discountid, $counterdiscount, $discountamount, time(), $boxsize, $closingsession, $pkpodetailid, $customerid, $tax, $taxable, $remainingquant , $pkboxbarcodeiD);
                         ...
                         /*   try
                            {
                                ...
                                $count = $dbh->exec("UPDATE pricechange SET fkbarcodeid = '$pkbarcodeid' , price = '$newprice', countername = '$countername' ,pupdatetime='$changetime' WHERE pkpricechangeid='$fkpricechangeid' ");*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	 $url_insert = ('http://192.168.10.110/admin/accounts/local_counter_prc_change.php?fkpricechangeid='.$fkpricechangeid.'&fkaddressbookid='.$fkaddressbookid.'&oldprice='.$changeprice.'&fkbarcodeid='.$pkbarcodeid.'&price='.$newprice.'&countername=1&qtype=1');
                       ...
                       /* try
                        {
                            ...
                            $count = $dbh->exec("INSERT INTO pricechange (fkbarcodeid, price, countername , inserttime) VALUES ('$pkbarcodeid', '$newprice', '$countername' , '$changetime') ");
                            $fkpricechangeid = $dbh->lastInsertId();
                            $count = $dbh->exec("INSERT INTO pricechangehistory (fkpricechangeid, fkaddressbookid, updatetime, oldprice) VALUES ('$fkpricechangeid', '$fkaddressbookid', '$changetime', '$changeprice') ");*/
   
   /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	 $url_insert = ('http://192.168.10.110/admin/accounts/local_counter_prc_change.php?fkpricechangeid='.$fkpricechangeid.'&fkaddressbookid='.$fkaddressbookid.'&oldprice='.$changeprice.'&fkbarcodeid='.$pkbarcodeid.'&price='.$newprice.'&countername=1&qtype=2');
                    $recDataE = file_get_contents($url_insert);			
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////								
