...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$query = "SELECT cf.pkclosingid cid,sum(cf.totalsale) sale,cf.countername,(SELECT sum(s.globaldiscount) as discount from $dbname_detail.sale s
...
3916,12425,3911,3913,3914,12762,12782,85275,56445,56446,11269,13223,13224,13225,13226,13328,13365,11324,11325,11326,13864,14141,14146,11404,11426,48946,56398,56517,56518,56519,56520,56521,85271,85693,85690,85272,85273,85274,85694,85687,85685,85688,70725,85684) group by s.fkclosingid) as mobilecardsale
...
$accsent=file_get_contents("http://210.2.171.14/ac_verify/dailysale.php?data=$jdata&location=0&sdate=$sdate");
