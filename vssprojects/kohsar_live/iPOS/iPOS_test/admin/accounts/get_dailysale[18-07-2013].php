...
catch(PDOException $e)
{
 ...
 $query = "SELECT  case s.fkaccountid when '0' then 'General' else 'Credit' end fkaccountid, sum(s.totalamount) - sum(s.globaldiscount) sale, sum(s.globaldiscount) as discount,
...
$query = " SELECT s.pksaleid,s.fkaccountid,sum(s.totalamount) sale from $dbname_detail.sale s 
