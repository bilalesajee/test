...
<th width="134" bgcolor="#000000" style="color:#FFFFFF">Sale Price</th>
<th width="148" bgcolor="#000000" style="color:#FFFFFF">Purchase Price</th>
<th width="100" bgcolor="#000000" style="color:#FFFFFF">Cost Price</th>
<th width="120" bgcolor="#000000" style="color:#FFFFFF">Price In RS</th>
...
<td width="134" align="right">'. $result[$i]['saleprice'].'</td>
<td width="148" align="right">'. round($result[$i]['purchaseprice'],2).'</td>
<td width="100" align="right">'.round($result[$i]['costprice'],2).'</td>
<td width="120" align="right">'.round($result[$i]['priceinrs'],2).'</td>
...
<th width="130" bgcolor="#000000" style="color:#FFFFFF">Sale Price</th>
<th width="145" bgcolor="#000000"style="color:#FFFFFF">Purchase Price</th>
<th width="101" bgcolor="#000000" style="color:#FFFFFF">Cost Price</th>
<th width="120" bgcolor="#000000" style="color:#FFFFFF">Price In RS</th>
</tr>';
...
<td width="145" align="right">'. round($result_lowest[$i]['purchaseprice'],2).'</td>
<td width="101" align="right">'. round($result_lowest[$i]['costprice'],2).'</td>
<td width="120" align="right">'.round($result_lowest[$i]['priceinrs'],2).'</td>
</tr>';
...
<th width="92" bgcolor="#000000" style="color:#FFFFFF">Price In RS</th>
<th width="110" bgcolor="#000000" style="color:#FFFFFF">Purchase Price</th>
<th width="110" bgcolor="#000000" style="color:#FFFFFF">Cost Price</th>
...
<td align="right">'. round($result_expiry[$i]['priceinrs'],2).' &nbsp;</td>
<td align="right">'. round($result_expiry[$i] ['purchaseprice'],2).'&nbsp;</td>
...
$to = "fahadbuttqau@gmail.com,accounts@esajee.com,abdul.rahim@esajee.com";
