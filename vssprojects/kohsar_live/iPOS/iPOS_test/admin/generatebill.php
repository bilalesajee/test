...
//amount summary paid and total payment methods
...
//
$customersid	=	$AdminDAO->getrows("$dbname_detail.sale","fkaccountid,customerbalance","pksaleid='$saleid'");
...
<tr align="right">
	...
	<td>
	<?php 
	$prev_customerbalance_=file_get_contents('http://192.168.10.100/accounts/customer_balance.php?customer='.$customerid);
	echo ($prev_customerbalance_); 
	?> </td>
</tr>
<?php
}
