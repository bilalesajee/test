    ...
    Website: www.esajee.com<br />
		...
		<?php
			...
			$sdquery	=	"SELECT
								...
								case when sd.taxable = 1 then 0 else 1 end taxable,
...

			{
				...
				$taxable            =   $saledetail[$k]['taxable'];

				$tax				=	$taxpercentage/100*$amount * $taxable;
