...
function printgrid($title)
{
	...
	<div align="center"><img src="../images/esajeelogo.jpg" />
	</div>
	<div align="center" style="font-size:12px;">Printed By: <?php echo $_SESSION['name'];?> On: <?php echo date('m-d-Y h:i:s',time());?> </div>
