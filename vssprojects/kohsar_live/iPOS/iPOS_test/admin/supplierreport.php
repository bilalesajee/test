...
include_once("../export/exportdata.php");
	...
	$sql	=	"
								...
								SELECT
									...
									pkcurrencyid,
									pd.saleprice,d.quantity as damage_quantity

								FROM 

									$dbname_detail.stock st LEFT JOIN addressbook ON (fkemployeeid=pkaddressbookid) left join $dbname_detail.podetail pd on (pkstockid=pd.fkstockid) left join $dbname_detail.damages d on (pkstockid=d.fkstockid) left join shipment on (st.fkshipmentid=pkshipmentid) LEFT JOIN currency ON (shipmentcurrency=pkcurrencyid),barcode
								...
								WHERE 
									...
									st.fkbarcodeid=pkbarcodeid and st.quantity > 0
...
<input type="hidden" name="data" id="data" />
	...
	<?php
...

		{
			...
			<tr>
				...
				<td bgcolor="#FF3300"><?php echo $result[$i]['damage_quantity'];?></td>
              ...
              <?php if($result[$i]['saleprice']>0){?>  <td  bgcolor="#00CC33"><?php echo $result[$i]['saleprice'];?></td><?php }?>
                ...
                <td align="right" bgcolor="#FF8B17"><?php echo number_format($result[$i]['costprice'],2);?></td>
                <td align="right" bgcolor="#FF8B17"><?php echo number_format($unitscostprice,2);?></td>
	...
	<tr>
			  ...
			  <td align="right">&nbsp;</td>
			  <td align="right">&nbsp;</td>
			  <td align="right" bgcolor="#FF3300">&nbsp;</td>
	   <td align="right">&nbsp;</td>
		     <?php if($currencyid!=3){?> <td align="right"><b><?php echo number_format($totalpprice,2);?></b></td><?php }?>
			  <td align="right">&nbsp;</td>
			  <td align="right" bgcolor="#FF8B17"><b><?php echo number_format($totalcostprice,2);?></b></td>
