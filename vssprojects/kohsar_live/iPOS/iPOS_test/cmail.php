...
$netsales	=	$closingarray[0]['totalsale']-$tdisk; 
 ...
 $query_advance = "SELECT SUM(c.amount) as advance_booking from $dbname_detail.sale s left join $dbname_detail.coupon_management c on c.pkcouponid = s.fkcouponid
...
<table width='300' style='font-size:9px;font-family:Lucida Sans Unicode, Lucida Grande, sans-serif; border-collapse:collapse; border-color:#FFF;margin-top:10px;' class='simple'>
  ...
  <tr>
   ...
   <tr>
    ...
    <th align='right'>". numbers($result_query_advance[0]['advance_booking'])."</th>
