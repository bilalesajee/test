...
function genBarCode($bc,$img)
{
	...
	require_once('class/code128.barcode.php');
	...
	5 - Text
	6 - Text Font (0-5) */
	$code_generated = new code128(30,$color_black,$color_white,1,$bc,2);
	...
	4 - Background color */
	$drawing = new FDrawing(1024,1024,"$img",$color_white);
