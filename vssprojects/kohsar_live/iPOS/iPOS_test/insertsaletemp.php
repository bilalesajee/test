...

{
 ...
 //    $retreason			=	$_POST['returnreason'];
...

	{
			...
			$fields	=	array("printid","datetime","countername","fkuserid","fkaccountid","fkstoreid","globaldiscount","fkclosingid", "fkloginhistoryid");
		...
		$data	=	array($printid,time(),$countername,$empid,$customerid,$storeid,$globaldiscount,$closingsession,$hisoryID);
...

	{
		...
		$saledetaildata	=	$AdminDAO->getrows("$dbname_detail.saledetail","pksaledetailid,quantity","fksaleid='$tempsaleid' AND fkstockid='$stockid' AND saleprice='$newprice' LIMIT 0,1");
...

		{
			...
			$newQuantity=$jafqty+$saledetaildata[0]['quantity'];
             //////////////////////////Code Added By Fahad 01-03-2013/////////////////////////////////////////////////////////////////
			...
			{
				$tax	=	($newprice*$salestaxper/100)*$newQuantity;
			
			}else if($taxable!=1 && $customerid!='' && $newprice==''){
				
				$tax	=	($price*$salestaxper/100)*$newQuantity;
			...
			$updatesaledetail	=	"UPDATE 
									...
									SET 
										...
										remainingstock='$remainingquant',taxamount='$tax',
...

		{
...

			{
				...
				$chfields		=	array('fkbarcodeid','price','countername','pupdatetime');
...

				{
					...
					$pcfields			=	array('fkpricechangeid','fkaddressbookid','updatetime','oldprice');
                     ...
                     $chdata				=	array($pkbarcodeid,$newprice,$countername,$changetime); 
 ...
 $url_insert = ('https://kohsar.esajee.com/admin/accounts/local_prc_change.php?fkpricechangeid='.$fkpricechangeid.'&fkaddressbookid='.$fkaddressbookid.'&oldprice='.$changeprice.'&fkbarcodeid='.$pkbarcodeid.'&price='.$newprice.'&countername=1&qtype=1');
                     $recDataE = ($url_insert);		
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
...

				{
                    ...
                    $chfields		=	array('fkbarcodeid','price','countername','pupdatetime','inserttime'); 
					$chdata				=	array($pkbarcodeid,$newprice,$countername,$changetime,$changetime);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	 $url_insert = ('https://kohsar.esajee.com/admin/accounts/local_prc_change.php?fkpricechangeid='.$fkpricechangeid.'&fkaddressbookid='.$fkaddressbookid.'&oldprice='.$changeprice.'&fkbarcodeid='.$pkbarcodeid.'&price='.$newprice.'&countername=1&qtype=2');
                    $recDataE = ($url_insert);			
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
