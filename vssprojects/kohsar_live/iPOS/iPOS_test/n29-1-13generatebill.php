...
if($customerid!=0){
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$check__row	=	$AdminDAO->getrows("$dbname_detail.sale","*","fkaccountid='$customerid'");
$check_radvance=count($check__row);
if($check_radvance==1){
//	echo "Hi".$customerid;
$c_adv	=	$AdminDAO->getrows("$dbname_detail.account","advance","id='$customerid'");	
$advance		=	$c_adv[0]['advance'];
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
$querycust = 	"SELECT 
...
?>
<tr align="right">  
	<td colspan="3">Advance Balance</td>
	<td><?php 
	// added by yasir -- 05-07-11
	echo $advance;
...
<tr align="right">
	...
	<?php 
	// added by yasir -- 05-07-11
	echo numbers($customerbalance_-$advance); 
	?> </td>
</tr>
...
<tr align="right">
	...
	<?php 
	// added by yasir -- 05-07-11
	echo numbers($customerbalance_ + $grandtotal); 
	?> </td>
</tr>
<?php
}
...
<img src="bc.png" width="101" height="43">
