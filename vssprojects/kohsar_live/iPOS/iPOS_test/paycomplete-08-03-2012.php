...
if(sizeof($_POST)>0)
{
	...
	if ($cash > 0){
		$AdminDAO->posttransaction($cashacc,$saleid,$price,$cashsaleacc,$saleid,$price,"Cash Sale");
	}
	
	if ($cc > 0){
		$AdminDAO->posttransaction($ccmachineaccountacc,$saleid,$price,$ccsaleacc,$saleid,$price,"Credit Card Sale");
	...
	if ($fc > 0){
		$AdminDAO->posttransaction($cashforeigncurrentacc,$saleid,$recamount*$fcrate,$fcsaleacc,$saleid,$recamount*$fcrate,"Foreign Currency Sale");
	...
	if ($cheque > 0){
		$AdminDAO->posttransaction($bankacc,$saleid,$price,$csaleacc,$saleid,$price,"Cheque Sale");
	}
