...

{
    ...
    $chk_issclose = "select is_close from 	$dbname_detail.sale where pksaleid='{$_GET['id']}'";
	$chk_isscl	  =	$AdminDAO->queryresult($chk_issclose);
    $clval		  =	$chk_isscl[0]['is_close'];
    if($clval==1){ ?>
	<script language="javascript">

			alert('No Return Because This Invoice is closed');
...

{
	...
	$sqldc="select 	
			...
			from 
				...
				$dbname_detail.sale s,customer c

			where 

				s.fkaccountid=c.pkcustomerid and s.pksaleid='$tempsaleid'";
...
//					$_SESSION['deliverychalan']=4;
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////					
	//////////////////////////////////////////////////ADDED BY FAHAD 13-07-2012///////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////					
						$sqlmx_sale			=	"select (max(serialno)+1) as maxsserial from $dbname_detail.sale";

						$mxarr_sale			=	$AdminDAO->queryresult($sqlmx_sale);

						$maxserial_sale		=	$mxarr_sale[0]['maxsserial'];
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////					
	//////////////////////////////////////////////////ADDED BY FAHAD 13-07-2012///////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////					
						...
						$sqlupdatesale="update 
										...
										set 
											...
											creditinvoiceno='$creditinvoiceno',serialno='$maxserial_sale'
...

{
    ...
    <?php if($_SESSION['invmode']!=''){?>
	  var returnitem	=	document.getElementById('returnreason').value;
	 if(returnitem==''){
...
<input type="text" name="returnreason" class="text" id="returnreason"   />
