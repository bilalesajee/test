...
//	exit;
	$field	=	array("openingdate","fkaddressbookid","countername","closingnumber","fkstoreid","openingbalance");
	$data	=	array(time(),$empid,$countername,$closingnum,$storeid,$declaredamount);
