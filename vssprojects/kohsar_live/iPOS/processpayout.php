...
if(sizeof($_POST)>0)
{
	...
	if($insertid > 0){
       ...
       $body =file_get_contents("https://kohsar.esajee.com/payoutmail.php?counter=$countername&closing=$closingsession&cashier=$empid&accounttitle=".urlencode($accountname)."&currentpayout=$amount");
