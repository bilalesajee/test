...
{ 
	...
	jQuery('#expdiv').load('getprodata.php?code='+inputdata);
	  ...
	  window.setTimeout(submitformsale, 1000);
                 //submitformsale();
...

{
...

	{
		...
		if(parseInt(qval)<-3000){
	notice('You can not subtract more than 3000 units at once','',5000);
          return false;
}else{
			submitformsale();
	        return false;
...
<div id="barcode">
    ...
    <div class="Row">
     ...
     <!--   <label>Stock</label>-->
            ...
            <div id="expdiv" >
              ...
              <input type="hidden" name="exp" class="text" id="exp" readonly="readonly"/>
   ...
   <div class="Row">
      ...
      <span class="buttons">
        ...
        <button type="button" name="button" id="button" onclick="submitformsale();"  onkeydown="javascript:if(event.keyCode==13) {submitformsale();}" title="ENTER">
