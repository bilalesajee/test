...
where s.pksaleid = '$saleid' and s.status = 1 and s.fkaccountid != 0    ";
			...
			$creditor_link= file_get_contents("http://192.168.10.100/accounts/pos_common_entry.php?type=credit_sale&fkaccountid={$fkaccountid}&sale={$sale}&return={$return}&pksaleid={$pksaleid}");
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   // echo 1;
    fclose($fp_acc);
}
