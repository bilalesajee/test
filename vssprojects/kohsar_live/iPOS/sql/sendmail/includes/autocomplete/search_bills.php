<?php 
	...
	?>
		<li id="<?php echo $i;?>" value="<?php echo $barcodeidlist;?>">
              <a href="javascript:void(0)" onclick="getlitext_('<?php echo $i;?>');fillbarcode('<?php echo $barcodeidlist;?>');" id="<?php echo $i;?>_l" class="<?php echo $barcodeidlist;?>"><?php echo $getRecord[$d]['itemdescription']; ?></a>
        </li>
	<?php 
		$i++;
	} 
