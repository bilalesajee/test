...
$counterinfo	=	$AdminDAO->getrows("$dbname_main.counter","countertype","countername='$countername'");
...
?>
    <li> 
    	<?php 
			$counter	=	$countername;
			$pendingsalerows	=	$AdminDAO->getrows(" $dbname_main.sale "," pksaleid,from_unixtime(datetime,'%d-%m-%y  %h:%i:%s') as datetime"," countername='$counter' and status='3' order by pksaleid DESC");
			?>
