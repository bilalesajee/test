...
session_start();
?>
<div id="quotetitlediv"><div   style="position:absolute;background-color:#000;padding:6px;-moz-border-radius:3px;-webkit-border-radius:4px;font-weight:bold;color:#fff;float:left;" ><?php if($_SESSION['quotetitle'] != '') { echo $_SESSION['quotetitle']; } ?></div></div>
<div id="user">
<?php
