...
function sendPayoutEmail($counter,$closingsession, $empid,$acclimit,$accountname,$totalpayouts,$amount){		
	  ...
	  //$to = "uuaqarahmed@gmail.com,batchjobs@gmail.com";
	  $subject = "Esajee Gulberg Payout on $date Closing ID $closingid AccountID $acid";
	...
	$body = "<link rel='stylesheet' type='text/css' href='http://gullhr.esajee.com/includes/css/style.css' />
<div align='left'>
